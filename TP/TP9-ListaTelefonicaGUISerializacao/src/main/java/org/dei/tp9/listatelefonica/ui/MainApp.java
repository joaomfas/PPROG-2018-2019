...
import org.dei.tp9.listatelefonica.controllers.JanelaPrincipalController;
...
public class MainApp extends Application {
    ...
    public void start(Stage stage) {
        try {
            ...
            FicheiroListaTelefonica flTel = new FicheiroListaTelefonica();
            ListaTelefonica listaTelefonica = flTel.ler();
            ...
            stage.setOnCloseRequest(new EventHandler<WindowEvent>() {
                ...
                public void handle(WindowEvent event) {
                    ...
                    if (alerta.showAndWait().get() == ButtonType.CANCEL) {
                        ...
                        FicheiroListaTelefonica fiTel = new FicheiroListaTelefonica();                     
                        fiTel.guardar(listaTelefonica);
                    }
                }
            });
            stage.show();
